...
export function App() {
  ...
  const mailto = useMemo(() => {
    const subject = locale === "pt" ? "Quero resolver uma dor com a Kaiser Tech" : "I want to solve a pain with Kaiser Tech";
    return `mailto:contato@kaisertec.com?subject=${encodeURIComponent(subject)}`;
  }, [locale]);
  ...
  return (
    <div className="app-shell" ref={appRef}>
      ...
      <section className="contact-section" id="contact">
        ...
        <form className="contact-form" action={mailto} method="post" encType="text/plain" data-animate>
          <label>
            {t.form.name}
